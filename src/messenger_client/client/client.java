package messenger_client.client;
...
public class client extends javax.swing.JFrame 
{
    ...
    public static String encrypt(String str) {
     ...
     // byte[] enc = ecipher.doFinal(utf8);   // encode to base64
      //enc = BASE64EncoderStream.encode(enc);
        // return new String(enc);
        return new String(BASE64EncoderStream.encode(utf8));
        }
     catch (Exception e) {
             e.printStackTrace();
        }
  ...
  //----------------------------Decrption --------
    ...
    try {
       byte[] dec = BASE64DecoderStream.decode(str.getBytes());   // decode with base64 to get bytes
        ...
        public void run() 
        {
            ...
            try 
            {
                while ((stream = reader.readLine()) != null) 
                {
                     ...
                     {
                         String decrypted_msg=decrypt(data[1]);
                         //ta_chat.append("\n Got Message befor decrypt was :: "+data[1] );
                        ta_chat.append(data[0] + ": " + decrypted_msg + "\n");
    ...
    private void initComponents() {
        ...
        ta_chat.setBackground(new java.awt.Color(255, 240, 240));
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(tf_chat, javax.swing.GroupLayout.PREFERRED_SIZE, 321, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void b_sendActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_b_sendActionPerformed
        ...
        if ((tf_chat.getText()).equals(nothing)) {
            ...
            try {
                String encrpted_msg=encrypt(tf_chat.getText());
                ta_chat.append("\n"+" Encrypted Message :: "+encrpted_msg+"\n");
               writer.println(username + ":" + encrpted_msg + ":" + "Chat");
